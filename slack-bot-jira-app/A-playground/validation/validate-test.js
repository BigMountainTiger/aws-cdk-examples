...
const validate_jira = async () => {
  const user_name = 'Song';
  const url_template = 'https://mlg-playground.atlassian.net/rest/api/2/user/search?query=name%3D{user-name}}';
  const url = url_template.replace('{user-name}', user_name);
