...
// This tests decrypting the signature
const test_descryt = async () => {
  ...
  console.log();
  const descrypted_signature = crypto.publicDecrypt(pem, signature).toString('base64');
  console.log(descrypted_signature);
...
(async () => {
  ...
  // Just try to descipt a signature
  // await test_descryt();

  // Require deployed the cognito and add an user
  // await test_login();
